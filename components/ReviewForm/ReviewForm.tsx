...
import {IReviewForm, IReviewSentResponse} from "./ReviewForm.inteface";
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            >
                ...
                />
                <Input
                    {...register('title', { required: { value: true, message: 'Required title' } })}
                ...
                <div className={styles.submit}>
                    ...
                    <span className={styles.info}>* Перед публікацією відгук пройде попередню модерацію і перевірку</span>
                </div>
            </div>
            {isSuccess && <div className={cn(styles.success, styles.panel)} role='alert'>
                <div className={styles.successTitle}>Ваш відгук відправлений</div>
                <div>
                    Thanks you, your review will be published after verification.
                </div>
                <button
            ...
            {error && <div className={cn(styles.error, styles.panel)} role='alert'>
                Виникла помилка, спробуйте іншим разом!
                <button

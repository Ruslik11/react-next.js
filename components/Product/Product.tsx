...
import {declOfNum, priceCurrency} from "../../helpers/helpers";
        ...
        <div className={className} {...props} ref={ref}>
            <Card className={styles.product}>
                ...
                <div className={styles.price}>
                    <span><span className='visualyHidden'>Price</span>{priceCurrency(product.price)}</span>
                    {product.oldPrice && <Tag className={styles.oldPrice} color='green'>
                        <span className='visualyHidden'>Sale</span>
                        {priceCurrency(product.price - product.oldPrice)}
                    </Tag>}
                </div>
                <div className={styles.credit}>
                    <span className='visualyHidden'>Credit</span>
                    {priceCurrency(product.credit)}/<span className={styles.month}>mth</span>
                </div>
                ...
                <div className={styles.rateTitle}>
                    <a href="#ref" onClick={scrollToReview}>
                        {product.reviewCount} {declOfNum(product.reviewCount, ['відгук', 'відгука', "відгуків"])}
                    </a>
                </div>
